...
export type Category = 'hats' | 'glasses' | 'accessories' | 'faces';
...
const SVG_ASSETS = {
  ...
  crown_gold: `<svg viewBox="0 0 100 80" xmlns="http://www.w3.org/2000/svg">
    <path d="M5 60 L 5 20 L 25 40 L 50 10 L 75 40 L 95 20 L 95 60 Z" fill="#FFD700" stroke="#DAA520" stroke-width="2"/>
    <circle cx="5" cy="20" r="5" fill="#FF4500"/>
    <circle cx="50" cy="10" r="6" fill="#FF4500"/>
    <circle cx="95" cy="20" r="5" fill="#FF4500"/>
    <circle cx="25" cy="40" r="3" fill="#32CD32"/>
    <circle cx="75" cy="40" r="3" fill="#32CD32"/>
  </svg>`,
  ...
  ribbon_bow: `<svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg">
    <path d="M100 70 C 100 70, 40 10, 20 40 C 0 70, 40 100, 100 70" fill="#FF99CC" stroke="#FF6699" stroke-width="3"/>
    <path d="M100 70 C 100 70, 160 10, 180 40 C 200 70, 160 100, 100 70" fill="#FF99CC" stroke="#FF6699" stroke-width="3"/>
    <path d="M100 70 Q 80 110 60 130 L 85 130 L 100 85" fill="#FF99CC" stroke="#FF6699" stroke-width="3"/>
    <path d="M100 70 Q 120 110 140 130 L 115 130 L 100 85" fill="#FF99CC" stroke="#FF6699" stroke-width="3"/>
    <rect x="90" y="60" width="20" height="20" rx="5" fill="#FF6699" stroke="#FF3366" stroke-width="2"/>
  </svg>`,

  necklace_pearl: `<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">
    <path d="M20 10 Q 100 90 180 10" fill="none" stroke="#D3D3D3" stroke-width="1"/>
    <circle cx="20" cy="10" r="6" fill="#FFF8DC" stroke="#D3D3D3" stroke-width="1"/>
    <circle cx="40" cy="30" r="7" fill="#FFF8DC" stroke="#D3D3D3" stroke-width="1"/>
    <circle cx="60" cy="45" r="8" fill="#FFF8DC" stroke="#D3D3D3" stroke-width="1"/>
    <circle cx="80" cy="55" r="9" fill="#FFF8DC" stroke="#D3D3D3" stroke-width="1"/>
    <circle cx="100" cy="60" r="10" fill="#FFF" stroke="#D3D3D3" stroke-width="1"/>
    <circle cx="120" cy="55" r="9" fill="#FFF8DC" stroke="#D3D3D3" stroke-width="1"/>
    <circle cx="140" cy="45" r="8" fill="#FFF8DC" stroke="#D3D3D3" stroke-width="1"/>
    <circle cx="160" cy="30" r="7" fill="#FFF8DC" stroke="#D3D3D3" stroke-width="1"/>
    <circle cx="180" cy="10" r="6" fill="#FFF8DC" stroke="#D3D3D3" stroke-width="1"/>
  </svg>`,
...
export const ASSETS: Asset[] = [
  ...
  { 
    ...
    anchorType: 'face', 
    defaultScale: 1.5,
    effectItems: ['🐟', '🐾'] // Fish + Paw
  },

  // Hats (Anchor to head)
  { id: 'h1', type: 'svg', content: SVG_ASSETS.crown_gold, category: 'hats', label: 'Crown', anchorType: 'head', defaultScale: 1.5, defaultOffsetY: -0.9 },
  ...
  { id: 'a2_ribbon', type: 'svg', content: SVG_ASSETS.ribbon_bow, category: 'accessories', label: 'Pink Bow', anchorType: 'body', defaultScale: 1.2, defaultOffsetY: 0.7 },
  { id: 'a3', type: 'svg', content: SVG_ASSETS.necklace_pearl, category: 'accessories', label: 'Necklace', anchorType: 'body', defaultScale: 1.2, defaultOffsetY: 0.8 },
];
